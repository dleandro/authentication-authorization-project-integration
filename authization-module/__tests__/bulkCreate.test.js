...
describe("Sequelize Testings", () => {
    ...
    test("Check bulk creation of UserRoles", async () => {
        ...
        const usersToAdd=[...Array(30).keys()].map(idx=>({UserId: idx+13, RoleId: 1, start_date: new Date('2020-09-03 16:58:59'), end_date:null, updater:1, active:1,username:`bulkTestUser${idx}`, password:'test', updater:1}));
    ...
    test("Check bulk creation of Users", async () => {
        ...
        const usersToAdd=[...Array(50).keys()].map(idx=>({username:`bulkTestUser${idx}`, password:'test', updater:1}));
    ...
    test("Check bulk creation of UserList", async () => {
        ...
        const permsToAdd=[...Array(30).keys()].map(idx=>({ListId:idx+4, UserId:1, updater:1, start_date:new Date('2020-09-03 16:58:59'), end_date:null, active:1}));
